...
if(isset($_POST['submit'])){
   ...
   $address = $_POST['flat'] .', '.$_POST['building'].', '.$_POST['area'].', '.$_POST['town'] .', '. $_POST['city'] .', '. $_POST['state'].', '. $_POST['country'].', '. $_POST['topping'];
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" class="box" placeholder="keju / nori" required maxlength="50" name="topping">
